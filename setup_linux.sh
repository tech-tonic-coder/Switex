...
if [[ "$1" == "help" ]]; then
    echo -e "\n=== Switex Shortcuts Help (Linux) ==="
    echo "General Shortcut:"
    echo "  Ctrl + Shift + Alt + Space : Toggle language"
    echo ""
    echo "Direct Shortcuts:"
    echo "  Ctrl + Shift + Alt + F : Force Persian"
    echo "  Ctrl + Shift + Alt + E : Force English"
    echo "  Ctrl + Shift + Alt + H : Force Hebrew"
    echo "  Ctrl + Shift + Alt + A : Force Arabic"
	echo "  Ctrl + Shift + Alt + R : Force Russian"
	echo "  Ctrl + Shift + Alt + T : Force Turkish"
    echo -e "=====================================\n"
    exit 0
fi
...
if [[ "$WAYLAND" == "false" ]]; then
    ...
    echo -e "${GREEN}╚══════════════════════════════════════════════════════════════╝${RESET}"
    echo ""
    info "General Hotkey: Ctrl+Shift+Alt+Space (Toggle languages)"
    info "Direct Hotkeys: Ctrl+Shift+Alt+F (Persian) | Ctrl+Shift+Alt+E (English)"
    info "                Ctrl+Shift+Alt+H (Hebrew)  | Ctrl+Shift+Alt+A (Arabic)"
    echo -e "  ${YELLOW}Note: Use Left Ctrl + Left Shift + Left Alt + Key.${RESET}"
...
echo "  4. 4. Press  Ctrl+Shift+Alt+Space"
