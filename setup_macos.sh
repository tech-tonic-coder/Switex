...
if [[ "$1" == "help" ]]; then
    echo -e "\n=== Switex Shortcuts Help (macOS) ==="
    echo "General Shortcut:"
    echo "  Ctrl + Shift + Alt(Option) + Space : Toggle language"
    echo ""
    echo "Direct Shortcuts:"
    echo "  Ctrl + Shift + Alt(Option) + F : Force Persian"
    echo "  Ctrl + Shift + Alt(Option) + E : Force English"
    echo "  Ctrl + Shift + Alt(Option) + H : Force Hebrew"
    echo "  Ctrl + Shift + Alt(Option) + A : Force Arabic"
	echo "  Ctrl + Shift + Alt(Option) + R : Force Russian"
    echo "  Ctrl + Shift + Alt(Option) + T : Force Turkish"
    echo -e "=====================================\n"
    exit 0
fi
...
echo ""
echo -e "${BOLD}General Hotkey: Ctrl+Alt+Space${RESET}"
echo "  Direct Hotkeys: Ctrl+Alt+F (Persian) | Ctrl+Alt+E (English)"
echo "                  Ctrl+Alt+H (Hebrew)  | Ctrl+Alt+A (Arabic)"
...
echo "  4. Press  Ctrl+Alt+Shift+Space"
echo "  5. Text is converted automatically"
echo ""
echo "   Or to use directly:"
echo "   1. Select the mistyped text"
echo "   2. Press  Ctrl+Alt+Shift+The First letter of the target language (for example, Ctrl+Alt+Shift+F to convert text from English to Persian)"
echo "   3. Text is converted automatically"
echo ""
echo "  To stop:"
